...
export default function Home() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        alert(
          "Thank you for contacting Orangehat Marketing! We will get back to you soon."
        );
        form.reset();
      } else {
      ...
      alert(
        "There was a problem submitting the form. Please check your connection and try again."
      );
    }
  };
    ...
    <main className="text-white bg-[#050505]">
      ...
      <header className="fixed w-full top-0 z-50 border-b border-[#1a1a1a] bg-[#050505]/90 backdrop-blur">
        <nav className="max-w-6xl mx-auto flex items-center justify-between p-4">
          {/* ✅ Replace icon logo with propaganda poster (floating with header) */}
          <a href="#hero" className="flex items-center gap-3">
            <div className="relative h-12 w-10 sm:h-14 sm:w-12 drop-shadow-[0_0_14px_rgba(224,90,30,0.28)]">
      ...
      <section
        id="services"
        className="services-section py-16 px-4 max-w-6xl mx-auto"
      >
      ...
      <section
        id="pricing"
        className="pricing-section py-16 px-4 max-w-6xl mx-auto"
      >
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-3">
          <div className="pricing-card bg-[#1a1a1a] p-8 rounded-xl text-center animate">
            ...
            <a
              href="#contact"
              className="border-2 border-[#E05A1E] text-[#E05A1E] px-4 py-2 rounded-full inline-block hover:bg-[#E05A1E] hover:text-white"
            >
              Choose Starter
            </a>
          </div>
      ...
      <section
        id="testimonials"
        className="testimonials-section py-16 px-4 max-w-6xl mx-auto"
      >
        <h2 className="text-3xl font-bold text-center mb-8 animate">
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-3">
          <blockquote className="bg-[#1a1a1a] p-6 border-l-4 border-[#E05A1E] rounded-md italic animate">
            <p>
              Since partnering with Orangehat, our entire operation has
              transformed. We're scaling without the chaos.
            </p>
      ...
      <section
        id="contact"
        className="contact-section py-16 px-4 max-w-2xl mx-auto text-center"
      >
        <h2 className="text-3xl font-bold mb-4 animate">Contact Us</h2>
        <p className="mb-8 animate">
          Have questions? Ready to get started? Reach out and we'll get back to you
          within 24 hours.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 animate">
          <div className="flex flex-col text-left">
            ...
            <input
              ...
              type="text"
              required
              className="p-3 rounded-md bg-[#121212] border border-[#444] focus:outline-none focus:border-[#E05A1E]"
            />
          </div>
          ...
          <button
            type="submit"
            className="bg-[#E05A1E] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#b9450e]"
          >
            Send Message
          </button>
        </form>

        <p className="mt-4 animate">
          Prefer to chat?{" "}
          <a
            href="#"
            onClick={handleBookDemo}
            className="underline text-[#E05A1E]"
          >
            Book a demo call
          </a>
          .
