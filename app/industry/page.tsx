...
const industries = [
  {
    ...
    desc: "General contractors, remodels, concrete, field crews.",
  },
  {
    name: "Energy & Solar",
    desc: "Solar installs, battery, energy services, utilities-adjacent.",
  },
  {
    name: "Roofing",
    desc: "Storm work, residential/commercial roofing, inspection-first sales.",
  },
  {
    name: "HVAC",
    desc: "Service calls, installs, maintenance plans, high-volume inbound.",
  },
  {
    name: "Professional Services",
    desc: "Appointments, consultations, high-intent follow-up.",
  },
  {
    name: "Hospitality",
    desc: "Hotels, resorts, property groups, guest experience workflows.",
  },
];
